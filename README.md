...
|2018年01月~現在|事業戦略本部 事業戦略部 BIグループ<br>兼<br>ビズリーチ事業本部 サービス開発本部(ビズリーチ) カスタマーマーケティング部(ビズリーチ) カスタマーマーケティングイノベーション(ビズリーチ)|上記に加え、マーケティングチームを兼務。<br>データドリブンマーケティングチームを目指すべく、データ基盤の整備、既存オペレーションの改善提案など、マーケティングチームと協働する形。|
...
- データサイエンス力 : データエンジニアリング力 : ビジネス力 = 2 : 5 : 3
    ...
    - データサイエンス力の1つ、統計学的知識については、資格取得のため勉強中。

### データ分析基盤

- データマイニングしようにも、大元の分析基盤が整っていないケースが多々ある。
- ビッグデータとは？高々100万レコードの処理に耐えられないデータ基盤を分析基盤と言えるのか？
- などと悶々としている。
