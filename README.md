...
|2011年04月~2012年10月|受託開発(tier 1~tier 3)|メンバーからリーダーまで幅広く担当|
|2012年11月~2013年08月|オープンWebシステムの運用保守を中心に、時々小規模〜中規模程度のシステム改修案件を請負いました。|メンバー -> 開発リーダー|
...
|2014年10月~2015年01月|炎上案件の火消し(主に瑕疵対応)|メンバー、テスト自動化チームリーダー|
|2015年02月~2016年07月|ビジネス専用メッセンジャーパッケージ「[COMPANY Messenger](http://www.worksap.co.jp/messenger/)」製品開発|メンバー -> プロダクトリーダー、アーキテクト|
|2016年08月~2017年04月|BIパッケージ「[LaKeel BI](https://bi.lakeel.com/)」製品開発|プロダクトマネージャー(≒プレイングマネージャー)、アーキテクト、PMO|
...
|2017年08月~2017年12月|事業戦略本部 事業戦略部 BIグループ(組織名変更のみ)|上記は継続。<br>データサイエンティストみたいなことしはじめてます。<br>非エンジニア向けにITリテラシーを向上する活動(技術提供、勉強会、ナレッジシェアリング等)も行ってます。|
|2018年01月~|事業戦略本部 事業戦略部 BIグループ<br>兼<br>ビズリーチ事業本部 サービス開発本部(ビズリーチ) カスタマーマーケティング部(ビズリーチ) カスタマーマーケティングイノベーション(ビズリーチ)|上記に加え、マーケティングチームを兼務。<br>データドリブンマーケティングチームを目指すべく、データ基盤の整備、既存オペレーションの改善提案など、マーケティングチームと協働する形。|
|2018年02月~|事業戦略本部 事業戦略部 BIグループ<br>兼<br>マーケティングテクノロジー室|マーケティングテクノロジー室を兼務。<br>デジタルマーケティングを目指すべく、分析基盤のあり方を考える人。|
|2018年05月~|マーケティングテクノロジー室<br>兼<br>事業戦略本部 事業戦略部 BIグループ|マーケティングテクノロジー室に主務を移しました。<br>データ分析基盤の要件定義、企画、設計、運用を担当。<br>データにまつわる知見を広めていき、データドリブン企業を推進すべく奮闘しています。|
...
- データサイエンス力 : データエンジニアリング力 : ビジネス力 = 2 : 5 : 3
    ...
    - Associate Data Scientist(独り⽴ちレベル)相当。

### デジタルマーケティング

データサイエンスの分野は、マーケティング分野と親和性の高い分野ではあるので、知見を基に施策に転じることのできるテーマとして着目しています。  
直近はジャーニーマップの可視化と最適化のための予測モデルを作成しています。

### データ分析基盤

- データ分析基盤構築に従事(2018年2月~)。
    - Google BigQuery
    - Data Studio
    - TREASURE DATA
    - Tableau
...
- 実績
    - SQL勉強会主催
    - Tableau Jediに向けてのエバンジェリング
    - Python塾講師
    - 構成管理(Git)ハンズオン

### 読書とそのアウトプット

- ただ本を読んでもつまらないので、議論したり書評を述べたりするアウトプット(という名の発散)が重要だと考えています。
- ジャンルはビジネス書、歴史。
...
- テクノロジーの力を使い、非効率業務にイノベーションを起こし、業務効率化を図っています。
...
海外と比べ、全体的に日本のエンジニアの質、量ともに劣っている点は感じています(特に質)。  
エンジニアのスキルの質向上、並びにエンジニアの数が増える世界を日々模索しています。
...
現職に就いて採用活動はしているものの、母数としては足りていない現状。  
中途採用から若手層やポテンシャル層に対する育成にシフトし、さらに、データアナリスト、データサイエンティストといったデータを活用する人材の価値を欧米諸国並に向上させるべく、知見と人脈を広げるためにイベントに参加したりしています。
(今後は登壇機会やLTといったアウトプットの場にシフトしていく予定です)
