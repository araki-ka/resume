...
|2011年04月~2012年10月|受託開発(tier 1~tier 3)のSIプロジェクトを転々と。|メンバーからリーダーまで幅広く。|
|2012年11月~2013年08月|オープンWebシステムの運用保守を中心に、時々小規模〜中規模程度のシステム改修案件を請負う。|メンバー -> 開発リーダー|
...
|2014年10月~2015年01月|炎上案件の火消し(瑕疵対応)|メンバー、テスト自動化チームリーダー|
...
|2016年08月~2017年04月|BIパッケージ「[LaKeel BI](https://bi.lakeel.com/)」製品開発|プロダクトマネージャー、アーキテクト、PMO|
...
|2018年02月~|事業戦略本部 事業戦略部 BIグループ<br>兼<br>ビズリーチ事業本部 サービス開発本部(ビズリーチ) カスタマーマーケティング部(ビズリーチ) カスタマーマーケティングイノベーション(ビズリーチ)<br>兼<br>マーケティングテクノロジー室|上記に加え、マーケティングテクノロジー室を兼務。<br>デジタルマーケティングを目指すべく、データ基盤のあり方を考える人。|
...
- R&D的な活動
    - Deep Learningだけでなく、機械学習全般について、業務に活かせるかどうかを検証中。
        - 重回帰分析を用いてCustomer領域のデータモデルパッケージを作成(継続中)。
        - 教師なし学習を用いたHR領域の予測モデルを適用してみる。
...
- 効率厨なので。
- エンジニアではない層は、リテラシーの壁もあって、有効にITを活用できていないファクトもある。
- テクノロジーの力を使い、思考停止してしまっている非効率業務にイノベーションを起こし、業務効率化を図ったりできないかと日々奮闘。
