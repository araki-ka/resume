...
|2014年10月~2015年01月|炎上プロジェクト案件の瑕疵対応|メンバー、テスト自動化チームリーダー|
...
|2018年08月~現在|システム本部マーケティングテクノロジー室<br>兼<br>事業戦略本部 事業戦略部 BIグループ|データ分析基盤の要件定義、企画、設計、運用保守。<br>Tableau Server管理者。<br>Tableauを利用したデータドリブン組織の醸成を牽引。|
