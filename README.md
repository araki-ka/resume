...
|2018年08月~現在|システム本部マーケティングテクノロジー室<br>兼<br>事業戦略本部 事業戦略部 BIグループ|データ分析基盤の要件定義、企画、設計、運用。<br>Tableauを利用してデータドリブン組織の醸成を牽引。<br>|
...
直近はデジタルマーケティングを牽引するデータ分析基盤の設計、構築、運用を行い、デジタルマーケティングのバックエンドを支えつつ、データ可視化のアドバイザーとして活動中。
